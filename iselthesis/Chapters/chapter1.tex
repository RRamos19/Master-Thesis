...
A exportação dos dados no formato \gls{xml} seguirão o padrão estabelecido pela \gls{itc}~2019. No formato \gls{csv}, serão exportadas as tabelas presentes na base de dados. Já nos formatos \gls{png} e \gls{pdf}, serão exportados exclusivamente os horários, sendo apresentados por meio de uma imagem típica de horário. No formato \gls{pdf}, a imagem será gerada como um gráfico vetorial.
