...
Os problemas de agendamento podem ser abordados por meio de duas subcategorias: Agendamento de Disciplinas Baseado no Currículo ou em inglês \gls{cb-ctt} e Agendamento de Disciplinas Após Inscrição ou em inglês \gls{pe-ctt}.
...
%TODO: Detalhar o que é exportado
