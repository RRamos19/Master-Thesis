...
%%%
%%% CONTRIBUTORS are welcome. Please contact "matilde.pato@isel.pt"
%%%
%%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\documentclass[
  docdegree=mscprep,    % msc(*), mscprep, bsc
  doctype=project, 		% dissertation(*), project
  lang=pt,              % en, pt(*)
...
\renewcommand{\printbib}{\printbibliography[title={Referências}]} % Muda a Bibliografia para Referências
\addtocontents{toc}{\protect{\pdfbookmark[0]{Índice}{toc}}} % Adicionar o Índice às bookmarks do leitor de pdfs
