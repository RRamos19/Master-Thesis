...
- [x] Export timetable to PNG
- [x] Periodical synchronizations with the database (if connected)
...
![default-look](Images/GUI_default_look.png)

Tool with data and connected to a database.

![data-and-connected](Images/GUI_data_database.png)

Window containing a timetable generated by the tool.

![timetable-look](Images/GUI_timetable_look.png)