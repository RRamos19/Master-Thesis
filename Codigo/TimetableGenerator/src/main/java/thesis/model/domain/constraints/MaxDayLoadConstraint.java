...
public class MaxDayLoadConstraint extends Constraint {
    public MaxDayLoadConstraint(String[] restrictionArray, Integer penalty, boolean required) {
        super(restrictionArray[0], penalty, required, Integer.valueOf(restrictionArray[1]));
    }
